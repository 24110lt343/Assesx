    ...
    return <div className="w-[85%] overflow-y-scroll scrollbar-thin scrollbar-thumb-gray-400">
            <div className="px-6 py-8">
              ...
              <p className="mt-2  text-[15px] font-normal leading-7 text-gray-500">
                Monitor your organization's recent activity, team updates, and workflow progress from one place. Stay informed and keep your hiring process moving smoothly.
              </p>
            </div>
